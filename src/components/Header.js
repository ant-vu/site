...
function Header() {
  ...
  return (
    <header className="">
      ...
      <h1 className="font-Outfit text-5xl font-bold">{">>"} av.</h1>
      ...
      <div className={`transition-all duration-500 ${showMore ? 'max-h-[1000px]' : 'max-h-0'} overflow-hidden ${showMore ? '' : 'm-0'}`}>
        <div className="border-2 border-dashed border-da_green rounded-md mt-4 p-2">
          ...
          <p className="mt-4 font-Inter font-normal">
            When I'm not busy, I enjoy pumping some iron, playing guitar, gaming, and making some random art. If you think that's cool and want to make some cool stuff together, don't hesitate to contact me. Cheers 🥂
          </p>
        </div>
      </div>
